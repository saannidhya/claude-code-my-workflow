...
transfers from 2007 to 2023, this paper provides, to my knowledge, the first
...
successions rather than immediate listings---the supply response is a
longer-horizon question this data will eventually answer. The family is a
first-order housing-market institution---it allocates homes by birth rather
than by price---and the tax code has been paying it to do so. \\
...
But county deed records reveal a second, parallel circulation of houses that
satisfies none of these definitions. Between 2007 and 2023, American families
...
This paper does three things. First, it measures the family channel. I
...
identifier, I can ask what happens to a home after it passes within a family.
...
single treated state, I assess these estimates against a placebo
...
buyers \citep{rosenthal2014filtering}. To my knowledge, no prior academic
...
is dense from 2007 through mid-2024; I use 2007--2023 for annual statistics
...
consideration, deed type, and name fields. I sharpen these flags into a
...
followed to the property's next arm's-length market sale, if any. I take all
...
The model's third prediction concerns the transfers that survive. I take
...
Inference comes first. California is a single treated state, so conventional
clustered standard errors understate uncertainty no matter how many control
states surround it; Table~\ref{tab:prop19} reports them only for
transparency. Inference in the text instead uses placebo-state permutation:
...
Five substantive threats deserve mention. \emph{COVID and the 2020--2021
...
California-specific cycle effects. \emph{Differential mortality and
...
planned refinement. \emph{The pulled-forward stock}: some of the post-period
...
shortfall---and none of the 2023 decline, which is the largest. \emph{Placebo
...
and the unadjusted one. \emph{Recording substitution}: families might route
